...
This repository contains the implementation of the paper "MagicDrive: Street View Generation with Diverse 3D Geometry Control" 
...
Compare MagicDrive with other mathods for generation quality:
